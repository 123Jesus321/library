...
const books = [
    ...
    },
    {
        ...
        author: "Вистериона",
        pdf: "VirtualWorldOfGuard (2).pdf",
        seriesId: "Virtual-ras",
        seriesTitle: "Виртуаль",
        seriesOrder: 1,
        updatedAt: "26-04-25",
        tags: ["фантастика", "параллельные миры", "авторская пунктуация", "вымышленная религия", "кроссовер", "повествование от нескольких лиц", "нелинейное повествование"],
        coverImage: "WorldOfGuard.jpg"
    },
    {
