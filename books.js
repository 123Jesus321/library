...
function renderLibrary() {    const grid = document.getElementById("book-grid");    if (!grid) return;
...
function renderReader() {    const frame = document.getElementById("reader-frame");    const title = document.getElementById("reader-title");    if (!frame || !title) return;
